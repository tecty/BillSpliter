    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='BillGroups.BillGroup')),
        ...
        migrations.AddField(
            model_name='bill',
            name='settlement',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Bills.Settlement'),
        ),
    ]
